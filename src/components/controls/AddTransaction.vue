<template>
    <div class="modal" :class="{ show: showModal }"
         aria-hidden="!showModal" @click="backdropClick">

      <div class="modal-content" role="dialog" aria-modal="true">
        <h3 id="modal-title">{{ editId ? "Edit Transaction" : "Add Transaction" }}</h3>
        ...
        <form @submit.prevent="onSubmit" ref="formRef">
          ...
          <select id="t-category-select" v-model="tCategory" @change="onCategoryChange">
          ...
          <input id="t-desc" type="text" v-model="tDesc" placeholder="Optional description" />

          <label for="t-amount">Amount</label>
          <input id="t-amount" type="number" min="0" step="0.01" v-model.number="tAmount" required />

          <div class="modal-actions">
            <button type="button" class="btn reset" @click="closeModal">Cancel</button>
...
const defaultCategories = ["Salary", "Food", "Shopping", "Bills", "Entertainment", "Travel", "Other"];
